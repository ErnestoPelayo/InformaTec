...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    *  private ArrayList<Events> dataset;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        Events events = dataset.get(i);
        viewHolder.tvName.setText(events.getName());
        viewHolder.tvEmail.setText(events.getUbication());
    }
    ...
    public void addPersons(List<Events> personList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tvEmail = itemView.findViewById(R.id.ubication);
        }
    }
    *
    * */
